...
const Template2 = () => {
  ...
  return (
    <div className="flex-row max-w-4xl mx-auto bg-white shadow-md p-5">
    <div className=" bg-gray-800 p-5 border-r border-gray-300" style={{ backgroundColor: backgroundColorss }}>
      
      <div className="" >
        
        <h1 className="text-2xl font-bold text-white mb-1" style={{ color: headerColor }}>{resumeData.name}</h1><br/>
        <h2 className="text-2xl font-medium text-white mb-10" style={{ color: headerColor }}>{resumeData.position}</h2>
        <ContactInfo
          mainclass="gap- mb-1 contact text-white"
          className="text-white"
          linkclass="inline-flex items-center gap-3 px-2"
          teldata={resumeData.contactInformation}
          emaildata={resumeData.email}
          addressdata={resumeData.address}
          telicon={<MdPhone className="text-2xl" />}
          emailicon={<MdEmail className="text-2xl" />}
          addressicon={<MdLocationOn className="text-2xl" />}
        />
      </div>
